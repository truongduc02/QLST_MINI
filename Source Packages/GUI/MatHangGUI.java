...
public class MatHangGUI extends JPanel implements MouseListener,KeyListener{
    ...
    private JLabel title,btnchonanh,txtrefresh,txtsearch,btnadd,btnedit,btndelete,lbmasp,lbloaisp,lbgiafrom,lbgiato,btnsearch,btnxuatfile,btnnhapfile;
            ...
            public void mouseClicked(MouseEvent e)
             {
                ...
                {
                    newImage= new ImageIcon(getClass().getResource("/images/boloai1.jpg"));
                    image=(newImage).getImage().getScaledInstance(215, 180,Image.SCALE_SMOOTH);
                }
...
//        }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(a.equals(tfmasp) || a.equals(tfgiato) || a.equals(tfgiafrom) 
                || a.equals(cmbloaihang))
        {
